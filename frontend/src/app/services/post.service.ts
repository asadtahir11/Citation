...
export class PostService {
  ...
  private urlRandom = "http://localhost:3000/post/random";
  ...
  getRandom(): Observable<Post[]> {
    return this.http
      .get<Post[]>(this.urlRandom, { responseType: "json" })
      .pipe(
        catchError(this.errorHandlerService.handleError<Post[]>("getRandom", []))
      );
  }
